# Contributing to ossval

First off, thank you for considering contributing to ossval! It's people like you that make ossval such a great tool.
...
```bash
# Clone your fork
git clone https://github.com/your-username/ossval.git
cd ossval
...
- [GitHub Discussions](https://github.com/SemClone/ossval/discussions)
- [Issues](https://github.com/SemClone/ossval/issues)
